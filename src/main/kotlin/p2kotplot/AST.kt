...
import p2kotplot.plotlytypes.builderName

/**
 * A builder function with a corresponding builder class
 */
data class Builder(val builderFunctions: MutableList<BuilderFunction>, val builderClass: BuilderClass)
data class BuilderFunction(val functionName: String, val parameters: MutableList<BuilderParameter>)
data class BuilderParameter(val parameterName: String, val parameterType: String)
data class BuilderClass(
    val className: String,
    val constructorParameters: MutableList<BuilderParameter>,
    val jsonArrayFields: MutableList<ArrayStatement>,
    val builders : MutableList<Builder>,
    val buildStatements : MutableList<String>
)

data class ArrayStatement(val arrayName: String, val arrayType: String)
